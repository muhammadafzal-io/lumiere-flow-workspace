...
**STEP 6 — Book it:** Call book_appointment with the name from STEP 1a (or omit client_name if they never gave one — never invent it), and omit client_email/birthday entirely — never invent them, see ABSOLUTE RULE above — using the exact startTime the caller picked in STEP 4.
